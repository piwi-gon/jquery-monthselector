...
$.widget("ui.monthSelectorWidget", {
    ...
    _fillMonthArray: function() {
         ...
         * the current month
         */
        var currMonth = this.dateObj.getMonth();
        var currYear  = this.dateObj.getFullYear();
        ...
        this.firstValue=currYear+"-"+(((currMonth) < 10) ? "0" : "") + (currMonth);
        currMonth = this.dateObj.getMonth();
        currYear  = this.dateObj.getFullYear();
        ...
        this.lastValue=currYear+"-"+(((currMonth) < 10) ? "0" : "") + (currMonth);
    },
